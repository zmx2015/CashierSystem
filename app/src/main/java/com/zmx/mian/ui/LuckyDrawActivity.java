...
public class LuckyDrawActivity extends BaseActivity {
    ...
    private TextView draw_text,chance_text;
    private String draw = "";//配置的积分
    private String chance = "";//配置的中奖概率
    ...
    protected void initViews() {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert_label("输入每次抽奖扣除的积分","draw",3);
        ...
        chance_text = findViewById(R.id.chance_text);
                ...
                case 1:
                    ...
                    try {
                        ...
                        if (jsonObject.getString("code").equals("1")) {
                            ...
                            draw = config.getString("draw");
                            chance = config.getString("chance");
                            ...
                            draw_text.setText(draw+"分");
                            chance_text.setText(chance);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(et.getText().toString()) || new Tools().isNumeric(et.getText().toString())) {
                    ...
                    if(name.equals("draw")){
                        ...
                        draw = et.getText().toString();

                    }else{

                        chance = et.getText().toString();
