...
//                sb.setS_id(s_id);
            ...
            case R.id.submit:
                ...
                if(goods_name){
                    ...
                    params.put("pid",  "1");
                    OkHttp3ClientManager.getInstance().getStringExecute("http://www.yiyuangy.com/admin/api.Purchase/insert", params, handler, 1, 404);
...
//    }
    ...
    public void loadingData(){
        ...
        OkHttp3ClientManager.getInstance().getStringExecute("http://www.yiyuangy.com/admin/api.Purchase/detail", params, handler, 2, 404);
