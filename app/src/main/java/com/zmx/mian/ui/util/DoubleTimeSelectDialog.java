...
import com.zmx.mian.adapter.NumericWheelAdapter;
            ...
            case R.id.tv_tclOk:
                ...
                try {
                    if (sdf.parse(mSelectStartTime).getTime() > sdf.parse(mSelectEndTime).getTime()) {
                        Tools.showText(mContext, R.string.time_start_larger_end_not_allowed, Tools.ONE_SECOND);
                    } else {
